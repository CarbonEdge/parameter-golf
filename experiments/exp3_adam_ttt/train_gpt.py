...
class Hyperparameters:
    ...
    ttt_adam_lr = float(os.environ.get("TTT_ADAM_LR", 0.0002))
    ttt_adam_beta1 = float(os.environ.get("TTT_ADAM_BETA1", 0.9))
    ttt_adam_beta2 = float(os.environ.get("TTT_ADAM_BETA2", 0.999))
...
def eval_val_sliding_ttt(
    ...
    log0(f"ttt_sliding:start chunks={num_chunks} chunk_tokens={ttt_chunk} "
         ...
         f"ttt_lr={args.ttt_lr} ttt_adam_lr={args.ttt_adam_lr} ttt_epochs={args.ttt_epochs} "
    ...
    optimizer = torch.optim.Adam(ttt_params, lr=args.ttt_adam_lr, betas=(args.ttt_adam_beta1, args.ttt_adam_beta2), eps=1e-8)
